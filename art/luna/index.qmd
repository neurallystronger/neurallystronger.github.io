...
So to with the life's colors to paint a picture for Luna.  
...
[^1]: **Toska** (Ru.) - polysemy/fuzzy concept. Toska *can* be translated, BUT only in specific contexts that "color" Toska some specific way. I provide no context and thus no coloring exists. (Voila, the stanza's last line rhymes this.) Note on writing: "Toska and sadness" implies Toska isn't sadness or an intensifier of sadness. [(Why would I repeat an alike word, or write a more intense version first, and a weaker one after?)]{.small-text} There are some amateur explanations such as <a href="https://www.goodreads.com/quotes/309633-toska---noun-t--sk---russian-word-roughly-translated-as" target="_blank"><em>Nabokov</em></a> [(Goodreads)]{.small-text} (who was restraintless -- the noble teen easily escaped Russia and immediately attended Cambridge -- bashing other writers) attributing Toska to sadness or boredom. **It shows Nabokov, the soulless outputter of technical drivel, had no clue.** Бред. A motivated, successful, and *content-in-life* multimillionaire can feel Toska too. [Abstract Contentment -- implying you do not experience... boredom or sadness -- doesn't preclude Toska, it just makes it less likely. Why?]{.small-text} Toska is simply the feeling of engrossed re-consideration of counterfactual simulation. Cognitively tiring. Descending into perpetuity. Both the good, the bad, and the random passing moments you paid no heed to, *getting you*. [**Toska is a *what-if***]{.underline}.

...
[^1]: **Toska** (Ru.) - I am keeping this word untranslated. Toska *can* be translated, BUT only in specific contexts that "color" Toska some specific way. I provide no context and thus no coloring exists. (Voila, the stanza's last line rhymes this.) Note on writing: "Toska and sadness" implies that Toska isn't sadness or an intensifier of sadness. (Why would you repeat a word, or write a more intense version first, and a weaker one after?) There are some amateur explanations such as Nabokov (who was restraintless -- the noble teen easily escaped Russia and immediately attended Cambridge -- bashing other writers) attributing toska to sadness or boredom. A highly driven successful executive can feel Toska too. Toska is simply the feeling of engrossed re-consideration of counterfactual simulation. Cognitively tiring. Descending into perpetuity. The good and the bad. Toska is a *what-if*. 

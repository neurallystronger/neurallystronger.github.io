...
**Acknowledged:**  
*be deeply unconscious in the NeuroICU*

- [1. Induction: through early days](#motivating)
- [2. (spoilered) Metaphysical fears: contemplating "escaping" myself](#lesson)
- [3. Gradient of reality: some conclusions](#concluding)

___

[WORK-IN-PROGRESS]{.review-what}
...
[^2]: Interestingly, current Language Machine Intelligence is a weird child not afraid of the darkness; it willingly gets lost in it — the softmax dot product thus was scaled by $\frac{1}{\sqrt{d_k}}$ precisely to counteract this abstract big set and turn the human-arbitrary output human-interpretable.
...
My discharge hypothesis was grotesque: the *Actual* ($A$) cross-references my dream ($p$). $A \subseteq p$. *"**My dream** is the law-like space from which the Actual gets projected"*. Huh. All while being unaware the *dream* isn't based in the *Actual* reality, but inside my mind's misunderstanding. (This was my psychosis). I desperately tried to break this and wake up. I clearly had a correct intuition in trying to find some inconsistency: the negation is indeed $\exists p_1 \in A, p_1 \notin p$. I needed to find the inconsistency. I needed to find a detail in the dream, an element $p_1 \in p$ such that it is inconsistent between the dream ($p$) I observe now and the pre-trauma Actual ($A$) I remember. Then, I would contently wake up from the *whatever's causing this*. I'd verify the landscape, the books, everything. On the second day I was discharged, the moment appeared. *I mechanistically opened one of the kitchen cabinets to grab a cup, only to find the plates inside. I was triumphant --- I threw a smug look at my parents and gazed around, expecting - what I can only call - the **firmament** to get razed down!* Annoyingly, nothing of the sort happened. My father laughed and agreed that he also gets confused when mother rearranges kitchenware.
...
First part discussed the **entrance** of "reality" and "consciousness", resulting in an induction observation.

Second part discussed the **exit** of "reality" and "consciousness", resulting in a metaphysical observation.

It seems we need to discuss the **process** rather than the endpoints.  
We will be unlikely to get an answer... but at least the essay will be aesthetically balanced?

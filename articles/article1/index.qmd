...
I suppose I did that for you. From <a href="https://scholar.google.com/citations?user=x6uUysgAAAAJ" target="_blank"><em>Tononi</em></a>, to parsing the <a href="https://www.sleep.pitt.edu/psqi" target="_blank"><em>PSQI</em></a> article, to reading all those endless (biased) college student cognitive-sleep studies. All to seek insights into **neurorehabilitation** in hopes others mimic my DAI 3 recovery success, and mine persists for decades.
...
*me\_today* = *recovery/internalization*(*me\_yesterday*) + *error*  
*me* = *sleep*() + *error*  
...
::: {.callout-tip collapse="false"}
## *Hand on heart*, my quantity is eh:
...
Extrinsic = mattress, pillow, an outside supplement or a medication.

Intrinsic = mind, cognition, psychology, long-term food habits, routines.

And on "power naps" --- sleep fulfills two different functions, recovery/internalization. A power nap can be effective at immediate physical recovery; it is often inadequate at internalization.

We must find the point in which we "sleep on it".

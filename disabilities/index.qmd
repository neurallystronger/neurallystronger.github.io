...
- [2. Critical Polytrauma (image spoilered) - Difficult Read](#polytrauma)
- [3. Improvement under a Grade 3 DAI](#dai)
...
![Preparing my first earmolds, 2010, 10 y.o.](../assets/2010.jpg){width=200px .d-block .mx-auto}
...
Still, the problem of *hearing* remained and was much more accentuated in a huge city university compared to a small community college. Abstractly, **communication breeds motivation**. In life, if you aren’t motivated to succeed, you get left behind. And every passing conversation, every auditory stimuli, every engaged tone, nevermind cooperative studying – they subtly nudge you to be better. Podcasts and audio recordings; every remark that was judged to not be included in the slides but said audibly – what a joke. I lacked this motivation, and it spills into attendance, work, effort; into everything. While I discovered and was the only UW undergrad attending PhD seminars in Micro, Macro, Dev. Econ and Econometrics (23 total), I struggled to anchor my hearing motivation, e.g., to pass a Real Analysis course.

**So, my (and any HoH, d, D person) [extrinsic]{.underline} motivation is restrained via the auditory dimension. However, a restrained person might have more avenues for [intrinsic]{.underline} motivation:**

## Critical Polytrauma (image spoilered) - Difficult Read {#polytrauma}
...
## Summarizing the Full Care Timeline until Home

***This shouldn't be - even remotely - used as a reference**. This is a z=3+ outcome while 1) conditioning only on severe TBI patients, 2) [generously discounting]{.underline} the entire "lost in the wilderness, delayed care" fiasco. **HOWEVER**, if the reader is driven to understand the philosophy of the human **mind** (for brutally practical or blissfully abstract reasons), then my attempts to convey whatever's in my head are on this website for your use.*\
**2024:**\
May 10 - fell 40 ft in Mt. Rainier wilderness.\
May 11 - found 24 hours later. Intubated E1V2M2, Harborview [*Neuro ICU*]{.underline}, L pupil size unreactive. **Estimate: unsure if will live**.\
May 12 - localizes upper extremities pain, only withdraws lower extremities. **Good sign consciousness [might]{.underline} be regained.**\
May 13 - camino removed, MRI confirms Grade 3 DAI.\
May 14 - extubated, some consciousness (3 days -- usually 1-2 months, :-( if ever).\
May 15 - [*General Care: Acute Care*]{.underline}, sounds.\
...
May 19 - [*General Care: Internal Medicine*]{.underline}. **NSGY unofficial estimate: 3 months**.\
May 20, 21 - BTW, that May 16 smile was a one off; I am a robot. No affect except when inconvenienced.\
...
May 31 - [*Rehabilitation*]{.underline}, memory largely returns (the only earlier memory is the "eurgh!!!" of the feeding tube in nose -- PTSD).\
June 1, 2, 3, 4, 5 - OT, ST, PT. Three 1 hour sessions daily. Moved on from soft foods June 4.\
June 6 - discharged home. Discharge moved up several days over the course of rehabilitation.
:::

## Improvement under a Grade 3 DAI {#dai}
...
![T2 FLAIR doesn't capture the blackness well, the "^" are small and barely discernible in the center; visible on SWI but damage impossible to see.](../assets/trauma_sketch.jpg){fig-align="center" width="50%"}
...
Summarily, **what do you do when your actions lack [velocity]{.underline}?** (vector of speed and direction)
...
[^1]: **Euglycemic/Starvation Ketoacidosis** might have been a needed defensive mechanism. Intuition: when neuronal structures popped apart (some instantly, some in hours-days that followed), they flooded the brain with ions, etc. Energy (glucose) went into restoration overdrive, and utilization of alternative energy sources was welcome. I am not a chemist. Keywords would be: "**ketones and brain injury**". FWIW, this is about the "extreme" (where my organism efficiently entered and exited ketone use). [I value carbs in *baseline* function in strongest terms possible]{.underline}. You can find compromised info online that generalizes and makes unsupported claims that complete glucose avoidance helps the brain - wrong. Though, [more glucose should *always* be followed with more cognitive or physical activity]{.underline}. **Do not let your cells develop insulin resistance**.

[^2]: **Full Care Timeline:** the first part of my first, clumsy essay, [Induction, Metaphysical Fears, and the Gradient of Reality](/essays/essay1.html), discusses why delirium was important.
